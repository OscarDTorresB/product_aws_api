...
import { aws_apigateway, aws_ec2, aws_lambda, aws_rds, Duration, RemovalPolicy } from "aws-cdk-lib";
...
export class ProductService extends Construct {
    constructor(scope: Construct, id: string) {
        ...
        const sgRDSProxy = new aws_ec2.SecurityGroup(
            this,
            "SgRDSProxy",
            {
                vpc,
        ...
        const rdsProxy = new aws_rds.DatabaseProxy(
            this,
            "ProductsDbProxy",
            {
                vpc,
        ...
        /* Lambda functions */
        const seedProductsLambda = makeLambda("seedProducts", "handlers/seedMockProducts.main")
        const getProductsListLambda = makeLambda("getProductsList", "handlers/getProductsList.main")
        const getProductByIdLambda = makeLambda("getProductById", "handlers/getProductById.main")
        const createProductLambda = makeLambda("createProduct", "handlers/createProduct.main")
